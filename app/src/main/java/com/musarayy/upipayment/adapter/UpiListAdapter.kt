package com.musarayy.upipayment.adapter
...
import kotlinx.android.synthetic.main.upi_payment_item_upi_list.view.*
...
class UpiListAdapter : RecyclerView.Adapter<UpiListAdapter.AppViewHolder>() {
    ...
    fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AppViewHolder {
        ...
        val layout = LayoutInflater.from(mContext).inflate(R.layout.upi_payment_item_upi_list, parent, false)
